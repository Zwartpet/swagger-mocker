 ...
 * @group unit
 */
class SwaggerMockRouteLoaderUnitTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        /** @var DocumentRepository $repositoryMock */
        $this->repositoryMock
            ->expects($this->any())
            ->method('get')
            ->willReturn($this->documentMock);

        $this->loader = new SwaggerMockRouteLoader($repositoryMock);
    }
    ...
    public function supportSwaggerAsRouteTypeOnly()
    {
        ...
        $this->assertTrue($this->loader->supports('/a/b/c', 'swagger-mock'));
    }
    ...
    public function canUseOperationIdForMethodName()
    {
        ...
        $this->assertSame(SwaggerMockRouteLoader::CONTROLLER_KEY, $actual->getDefault('_controller'));
    }
